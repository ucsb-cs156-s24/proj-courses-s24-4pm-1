...
describe("PersonalScheduleSelector", () => {
  ...
  test("sets the initial schedule from the filtered schedules if schedules match with quarter", () => {
    render(
    ...
    expect(screen.getByDisplayValue("Schedule 1")).toBeInTheDocument();
  });
